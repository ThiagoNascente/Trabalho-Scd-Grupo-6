#!/usr/bin/env bash
# ==========================================================================
# deploy6.sh — Máquina spaceship-engine3: Game Engine do jogo3 (Node + WebRTC).
#
...
# = deploy2; GECKOS_UDP_MIN/MAX. Preencha ENGINE3_HOST_PRIVATE/PUBLIC com os
...
log "===== deploy6 OK: engine jogo3 (Socket.io 4003 · WebRTC 5003 · UDP 20001-20030) ====="
