#!/usr/bin/env bash
# ==========================================================================
# deploy5.sh — Máquina spaceship-engine2: Game Engine do jogo2 (Node + WebRTC).
#
...
# = deploy2; GECKOS_UDP_MIN/MAX. Preencha ENGINE2_HOST_PRIVATE/PUBLIC com os
...
log "===== deploy5 OK: engine jogo2 (Socket.io 4002 · WebRTC 5002 · UDP 20001-20030) ====="
